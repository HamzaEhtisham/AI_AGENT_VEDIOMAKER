...
### Browser console: `chrome-extension://invalid/` `net::ERR_FAILED`

Ye app issue nahi hota. Ye browser extension side noise hota hai, safely ignore kar sakte ho.
Agar clean console chahiye, Incognito/guest window me without extensions app run karo.
